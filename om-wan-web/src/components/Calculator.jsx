          ...
          <div className="compact-results-area">
            ...
            <div className="compact-result-grid">
              ...
              <motion.div className="compact-card" whileHover={{ y: -3 }}>
                ...
                <div className="card-value" style={{ color: 'var(--text-dark)' }}><AnimatedNum value={totalAnnualReturn} prefix="₹" /></div>
              </motion.div>
              ...
              <motion.div className="compact-card" whileHover={{ y: -3 }}>
                <div className="card-label">Estimated Lifetime Return (Your 70% Share for 25 Years)</div>
                <div className="card-value"><AnimatedNum value={lifetimeReturn} prefix="₹" /></div>
              </motion.div>
            </div>

            {/* Information Note */}
            <div style={{ marginTop: '1.5rem', padding: '1rem', background: '#f8fafc', borderRadius: '8px', borderLeft: '4px solid var(--forest-green)' }}>
